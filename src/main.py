...
from core.ml_engine import MinDistanceClassifier, MaxDistanceClassifier
from core.controller import MLController

from views.config import setup_pyqtgraph, BG_MAIN, ACCENT_COLOR

from views.view_input import InputCard, InputExpandedPage
from views.view_charts import ChartsCard, ChartsExpandedPage
from views.view_algorithm import AlgorithmCard, AlgorithmExpandedPage
from views.view_accuracy import AccuracyCard, AccuracyExpandedPage
...
class MainWindow(QMainWindow):
    ...
    def train_model(self):
        ...
        try:
            ...
            if params['Algoritmo'] in ["Perceptron", "Rede Neural (MLP)"]:
            ...
            if params['Algoritmo'] == "Rede Neural (MLP)":
                self.page_charts.add_chart("Arquitetura da Rede Neural", "Arquitetura", [], [])
            ...
            preview_text = self.card_accuracy.preview_label.text()
            if "\n" in preview_text:
                resumo_acc = preview_text.split("\n")[1]
            else:
                resumo_acc = preview_text
